...
namespace SendGameStatusPlugin
{
    public class AiUtils
    {
        public static double calculateSkillScore(Gallop.SingleModeCheckEventResponse @event, double ptRate)
        {
            ...
            var tips = SkillTipsResponseAnalyzer.SkillTipsResponseAnalyzer.CalculateSkillScoreCost(@event, skills, true);
            ...
            var dpResult = SkillTipsResponseAnalyzer.SkillTipsResponseAnalyzer.DP(tips, ref totalSP, @event.data.chara_info);
